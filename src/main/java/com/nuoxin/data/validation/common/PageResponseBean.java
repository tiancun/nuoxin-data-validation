...
public class PageResponseBean<T> implements Serializable {
  ...
  public PageResponseBean(com.naxions.mini.common.PageRequestBean bean, Integer count, List<T> list) {
    super();
    ...
    if(count==0){
      ...
      if(bean.getPageSize()==0){
        throw new BusinessException(ErrorEnum.ERROR.getCode(),"不合法的分页请求参数");
      }
