...
public class SSHCommandExecutor {
    ...
    public static void main(final String [] args) {
        SSHCommandExecutor sshExecutor = new SSHCommandExecutor("47.95.22.53", "root","rec2017Nx!");
        sshExecutor.execute("python /usr/local/tfidf/temp/tf_idf.py /usr/local/tfidf/temp/input/doc1.txt");
